...
| C03 | Token/icon seam and one action primitive | L00 | U/L/E | Scoped | Active — C03a portable button/navigation handoff prepared at `65b6a55`; host CSS and interaction exit remain with main agent |
