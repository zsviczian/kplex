...
| C05 | Host-free shared suggester | C04 | U | Scoped | Active — C05a offline extraction handoff prepared from `9190241`; reviewer retains exact-build host/device acceptance |
